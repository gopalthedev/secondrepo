...
function LeftMenu() {
  ...
  return (
    ...
    <div className="flex flex-col border-r border-neutral-700 w-100 h-screen">
      {/* Profile nav */}
      <div className="flex justify-between items-center bg-[#202d33] h-[60px] p-4">
        {/* Profile picture */}
        <Image
          src={pp}
          alt="profile_picture"
      ...
      <div className="flex justify-between items-center h-[60px] p-2">
        ...
        <input
          ...
          className="rounded-lg bg-[#202d33] text-[#8796a1] text-sm font-light outline-none px-4 py-2 w-full h-full placeholder:text-[#8796a1] placeholder:text-sm placeholder:font-light"
        />
